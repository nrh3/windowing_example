...
select when_pung - time_since_last_ping as when_drought_began, when_pung as time_drought_ended, time_since_last_ping as how_long_drought_was  from 
	( select when_pung, when_pung - lag(when_pung)  over ( order by when_pung)  as time_since_last_ping  from incoming_pings) as x 
where time_since_last_ping > '2 hours'::interval order by when_drought_began;
